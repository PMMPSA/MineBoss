...
class ClaimSubCommand extends SubCommand
{
    ...
    public function execute(CommandSender $sender, array $args) {
        ...
        if ($this->getPlugin()->getProvider()->savePlot($plot)) {
			...
			$player->getInventory()->addItem(Item::get(8, 0, 4));
			$player->getInventory()->addItem(Item::get(10, 0, 4));
			$player->getInventory()->addItem(Item::get(297, 0, 4));
			$player->getInventory()->addItem(Item::get(79, 0, 2));
			$player->getInventory()->addItem(Item::get(103, 0, 2));
			$player->getInventory()->addItem(Item::get(352, 0, 2));
			$player->getInventory()->addItem(Item::get(361, 0, 2));
			$player->getInventory()->addItem(Item::get(81, 0, 2));
			$player->getInventory()->addItem(Item::get(338, 0, 2));
			$player->getInventory()->addItem(Item::get(295, 0, 2));
            ...
            $sender->sendMessage("§f• §eĐã Thêm§b Nước§e Và§6 Dung Nham§e Vào Kho Đồ Của Bạn");
        } else {
